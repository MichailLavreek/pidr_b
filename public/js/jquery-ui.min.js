...
( function( factory ) {
    ...
    datepicker.regional.ru = {
        monthNamesCustom: ["Января", "февраля", "Марта", "Апреля", "Мая", "Июня",
            "Июля", "Августа", "Сентября", "Октября", "Ноября", "Декабря"],
        yearNameCustom: 'Года',
        selectedQueueButtonText: 'Ваша очередь',
        customQueues: {'hold': 'Занята', 'half-hold':'Забронирована', 'free':'Свободная'},
...
( function( factory ) {
    ...
    datepicker.regional.uk = {
        monthNamesCustom: ["Січня","Лютого","Березня","Квітня","Травня","Червня",
            "Липня","Серпня","Вересня","Жовтня","Листопада","Грудня"],
        yearNameCustom: 'Року',
        selectedQueueButtonText: 'Ваша черга',
        customQueues: {'hold':'Зайнята', 'half-hold':'Заброньована', 'free':'Вільна'},
...
$.datepicker.regional.en.monthNamesCustom = ["January", "February", "March", "April", "May", "June",
    "Lipnia", "August", "Veresnya", "October", "November", "December"];
$.datepicker.regional.en.yearNameCustom = 'Year';
$.datepicker.regional.en.selectedQueueButtonText = 'Your queue';
$.datepicker.regional.en.customQueues = {'hold':'Busy', 'half-hold':'Reserved', 'free':'Free'};
