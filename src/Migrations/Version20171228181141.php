 ...
 */
class Version20171228181141 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, structure_id INT NOT NULL, alias VARCHAR(200) NOT NULL, is_active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_D34A04ADE16C6B94 (alias), INDEX IDX_D34A04AD2534008B (structure_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
