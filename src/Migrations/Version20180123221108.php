 ...
 */
class Version20180123221108 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_language ADD description LONGTEXT DEFAULT NULL, CHANGE language_iso2 language_iso2 CHAR(2) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_language DROP description, CHANGE language_iso2 language_iso2 CHAR(2) NOT NULL COLLATE utf8_unicode_ci');
