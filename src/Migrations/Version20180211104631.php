 ...
 */
class Version20180211104631 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, language_id CHAR(2) NOT NULL, product_price INT DEFAULT NULL, quadrature VARCHAR(100) DEFAULT NULL, client_name VARCHAR(200) NOT NULL, client_phone VARCHAR(200) NOT NULL, client_address VARCHAR(250) NOT NULL, created_at DATETIME NOT NULL, order_date DATE NOT NULL, order_queue INT NOT NULL, INDEX IDX_F52993984584665A (product_id), INDEX IDX_F529939882F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
