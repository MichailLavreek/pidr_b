 ...
 */
class Version20171225224919 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE variable (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(200) NOT NULL, value VARCHAR(200) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE variables (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(200) NOT NULL COLLATE utf8_unicode_ci, value VARCHAR(200) NOT NULL COLLATE utf8_unicode_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
