 ...
 */
class Version20171225211424 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX unique_structure_language ON structure_language');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_structure_language ON structure_language (language_iso2, structure_id)');
    }
}
