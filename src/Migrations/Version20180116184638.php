 ...
 */
class Version20180116184638 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_language CHANGE product_id product_id INT NOT NULL, CHANGE language_iso2 language_iso2 CHAR(2) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_language CHANGE product_id product_id INT DEFAULT NULL, CHANGE language_iso2 language_iso2 CHAR(2) NOT NULL COLLATE utf8_unicode_ci');
