 ...
 */
class Version20180211105212 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD status VARCHAR(255) NOT NULL, CHANGE language_id language_id CHAR(2) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP status, CHANGE language_id language_id CHAR(2) NOT NULL COLLATE utf8_unicode_ci');
